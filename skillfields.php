<form action="index.php">
	<select name="skill_fields" id = "skill_fields">
		...
		<option value="gove">Government &amp; Public Administration</option>
		<option value="heal">Health Science</option>
		<option value="hosp">Hospitality &amp; Tourism</option>
		<option value="huma">Human Services</option>
